...
| Long-lived Vary identity storage | lands at `0.181.1` | Retain exact bytes through immutable request leases or engine-frozen caller storage, never truncate/hash/tokenize equality, redact sensitive nominated fields, and downgrade locally to NoRecombine on capacity or released storage. |
