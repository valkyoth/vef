...
def main() -> int:
    ...
    failures.extend(["missing maximum-size terminal-event reservation contract"] if "event lease is sized and reserved for the largest normal or cancellation terminal event" not in detailed else [])
    if failures:
