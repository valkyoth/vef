...
def main() -> int:
    ...
    failures.extend(["MAX_FRAME_SIZE is still applied after acknowledgement"] if "after acknowledgement while retaining independent inbound hard limits" in detailed else [])
