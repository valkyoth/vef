...
def main() -> int:
    ...
    required_markers = (
        ...
        "Client partial-segment and incomplete-prefix validation",
    ...
    ordering = (
        ...
        ("Client correlation, cancellation, and retry tokens", "Client partial-segment and incomplete-prefix validation"),
        ("Client partial-segment and incomplete-prefix validation", "Cross-request partial assembly and header synthesis"),
    ...
    required_contract_text = (
        ...
        "`PartialResponseDisposition` bound permanently to the v0.180.4 validated request",
        "count semantic body octets through completion",
        "`StandaloneOnly`/`NoRecombine`",
        "`ValidatedIncomplete200Prefix`",
        "`StoredRepresentationSlice<'a>`",
        "`TransferDecodedContentEncoded` representation-byte domain",
        "Clean HTTP/2 END_STREAM with Content-Length disagreement is a malformed response",
